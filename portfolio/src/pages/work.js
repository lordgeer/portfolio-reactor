                        ...
                        <section className="card">
                            ...
                            <img class="card-img-top" src="../images/ttah.png" alt="Tabletop Auction House"></img>
                                <div class="card-body">
                                    ...
                                    <a href="https://github.com/lordgeer/Tabletop_Auction_House" target="_blank">GitHub Repo</a>
                                    </p>
                                </div>
                        </section>
                    </div>
                        ...
                        <section class="card">
                            ...
                            <img class="card-img-top" src="../images/note-taker.png" alt="Tabletop Auction House"></img>
                                <div class="card-body">
                                    ...
                                    <a href="https://github.com/lordgeer/Note_Taker" target="_blank">GitHub Repo</a>
                                    </p>
                                </div>
                        </section>
                    </div>
                    ...
                    <section class="card">
                        ...
                        <img class="card-img-top" src="../images/orsr.png" alt="Outer Rim Tech Blog"></img>
                            <div class="card-body">
                                ...
                                <a href="https://github.com/lordgeer/Tech_Blog" target="_blank">GitHub Repo</a>
                                </p>
                            </div>
                    </section>
                    </div>
                        ...
                        <section class="card">
                            ...
                            <img class="card-img-top" src="../images/ntg.png" alt="News The Gathering"></img>
                                <div class="card-body">
                                    ...
                                    <a href="https://github.com/lordgeer/Project-1-Group-8" target="_blank">GitHub Repo</a>
                                    </p>
                                </div>
                        </section>
                    </div>
